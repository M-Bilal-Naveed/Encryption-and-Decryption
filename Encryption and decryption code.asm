...
;Program use to encryption of enter data and decrytion it again by calling functions
...
.model small
org 100h
;* ORG - The origin directive sets the location counter to the value specified.

.data
    ; name type initializer
    sum DW 0
    delta DW 02ACh
    ;The Delta Component provides lookup, add and delete access to the Delta services outside of the normal Connector modes.
    v0 DW ?
    v1 DW ?
    k0 DW ?
    k1 DW ?
    k2 DW ?
    k3 DW ?
    msg1 DB 'Enter text of 4 letters: $'
    msg2 DB 0Dh,0Ah,'Enter password of 4 keys: $'    
